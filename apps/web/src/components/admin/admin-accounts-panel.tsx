...
export function AdminAccountsPanel() {
  ...
  return (
    ...
    >
      <div className={`${adminInsetClass} flex flex-col gap-3 p-4 md:flex-row md:items-center md:justify-between`}>
              ...
              {accounts.map((account: AdminAccount) => {
                ...
                return (
                  <TableRow key={account.userId}>
                    ...
                    <TableCell className="py-3">{formatCompactNumber(account.requests30d)}</TableCell>
                    <TableCell className="py-3">{formatCompactNumber(account.tokens30d)}</TableCell>
