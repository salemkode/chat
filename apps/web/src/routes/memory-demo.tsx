      ...
      <div className="max-w-7xl mx-auto space-y-8">
        <div>
          ...
          <p className="text-muted-foreground text-lg">
            This example demonstrates how to use the Convex-powered memory system with native vector
            search capabilities.
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className="bg-card text-card-foreground p-6 rounded-lg border-border">
            <h2 className="text-2xl font-semibold text-foreground mb-4">🔍 Vector Search</h2>
            <div className="space-y-4">
              <div className="bg-muted/50 p-4 rounded-md">
                ...
                <p className="text-sm text-muted-foreground">
                  The system uses <code className="text-primary">ctx.vectorSearch()</code> for fast,
          ...
          <li key={r.id}>
            ...
            <div>{r.source}</div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                ...
                <li>2. Convex finds most similar chunks using cosine similarity</li>
            ...
            <div className="bg-accent/10 p-4 rounded-md">
              <p className="text-sm text-accent-foreground">
                <strong>Performance:</strong> Native Convex vector search is ~10x faster
              </p>
            </div>
          </div>
...
└── memory/           # Detailed memory
    ...
    └── api-documentation.md`}
              ...
              <div className="space-y-4">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground">
                  <li>
                    <span className="text-primary">Markdown format:</span> Use clear structure
                  </li>
                  <li>
                    <span className="text-primary">Atomic entries:</span> One concept per entry
                  </li>
                  <li>
                    <span className="text-primary">Include context:</span> When/where to use
                  </li>
                  <li>
                    <span className="text-primary">Keep updated:</span> Document changes
                  </li>
                </ul>
              </div>
            </div>
  ...
  agentId: "agent-123",  // Same content
              ...
              <div className="bg-accent/10 p-4 rounded-md">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground ml-4">
                  <li>
                    <span className="text-primary">✓ Shared knowledge:</span> Content is accessible
                    to all agents
                  </li>
                  <li>
                    <span className="text-primary">✓ Semantic search:</span> Finds based on meaning
                  </li>
                  <li>
                    <span className="text-primary">✓ Persistent:</span> Remains across sessions
                  </li>
                  <li>
                    <span className="text-primary">✗ Personal store:</span> No user profiles stored
                  </li>
                </ul>
              </div>
              ...
              <div className="bg-accent/10 p-4 rounded-md">
                ...
                <ul className="list-disc list-inside space-y-1 text-sm text-muted-foreground ml-4">
                  <li>
                    <strong>Team agents:</strong> Share code documentation across team
                  </li>
                  <li>
                    <strong>Personal use:</strong> Each agent remembers your project context
                  </li>
                  <li>
                    <strong>Cross-session:</strong> Knowledge persists across conversations
                  </li>
                </ul>
              </div>
            </div>
          ...
          <div className="bg-card text-card-foreground p-6 rounded-lg border-border">
            <h2 className="text-2xl font-semibold text-foreground mb-4">🎨 CSS Variables</h2>
          ...
          <div className="space-y-3">
            <h3 className="text-sm font-semibold text-muted-foreground">Semantic Colors</h3>
            <div className="space-y-2 text-sm">
              <div className="flex items-center gap-2">
