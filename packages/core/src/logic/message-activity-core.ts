/** Pure activity-step logic shared by web and mobile (no UI). */
...
export function buildActivitySteps(parts: readonly unknown[], messageStatus: string) {
...
function getToolCallStatus(part: PartRecord, messageStatus: string): ActivityStatus {
