...
export type DataModel = {
  ...
  chatFiles: {
    ...
    indexes: {
      ...
      by_refcount: ["refcount", "_creationTime"];
    };
    searchIndexes: {};
    vectorIndexes: {};
  };
  chatMessageEmbeddings: {
    ...
    vectorIndexes: {
      by_embedding: {
        vectorField: "vector";
        dimensions: number;
        filterFields: "model" | "threadId" | "userId";
      };
    };
  };
  chatMessages: {
    document: {
      agentName?: string;
      embeddingId?: Id<"chatMessageEmbeddings">;
      error?: string;
      fileIds?: Array<Id<"chatFiles">>;
      finishReason?: string;
      message?: {
        content: any;
        providerOptions?: any;
    ...
    indexes: {
      by_id: ["_id"];
      by_creation_time: ["_creationTime"];
      by_embedding_thread: ["embeddingId", "threadId", "_creationTime"];
      by_thread_order: ["threadId", "order", "stepOrder", "_creationTime"];
      by_thread_status_order: [
        "threadId",
        "status",
        "order",
        "stepOrder",
  ...
  chatStreamDeltas: {
    ...
    indexes: {
      by_id: ["_id"];
      by_creation_time: ["_creationTime"];
      by_stream_start: ["streamId", "start", "end", "_creationTime"];
    };
    searchIndexes: {};
    vectorIndexes: {};
  };
  chatStreamingMessages: {
    document: {
      ...
      providerOptions?: any;
      state:
        | { kind: "streaming"; lastHeartbeat: number }
        | { endedAt: number; kind: "finished" }
        | { kind: "aborted"; reason: string };
      stepOrder: number;
      threadId: Id<"chatThreads">;
      userId?: Id<"users">;
      _id: Id<"chatStreamingMessages">;
      _creationTime: number;
    };
    fieldPaths:
      | "_creationTime"
